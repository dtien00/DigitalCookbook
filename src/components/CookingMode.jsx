...
export default function CookingMode({
    ...
    const stepDone = step && checkedSteps.has(step.id)
    ...
    return createPortal(
        ...
        >
            <div className="flex items-center justify-between gap-3 px-4 py-3 border-b border-paper-shade flex-shrink-0">
                <button
                    onClick={onExit}
            ...
            >
                {step ? (
                    <div className="max-w-2xl w-full">
                        <div className="font-display text-rust text-xs uppercase tracking-widest mb-6 text-center">
                            Step {currentStep + 1}
                        </div>
                        <p className={`font-serif text-2xl sm:text-3xl leading-relaxed text-center ${stepDone ? 'line-through text-ink/40' : 'text-ink'}`}>
                            {step.instruction}
                        </p>
                        <div className="flex justify-center mt-10">
                            <button
                                onClick={() => toggleChecked(setCheckedSteps, step.id)}
            ...
            <div className="flex items-center justify-between gap-3 px-4 py-4 border-t border-paper-shade flex-shrink-0">
                <button
