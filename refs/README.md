...
| [INPUT.md](./INPUT.md) | research · partly shipped | Alternative recipe-input methods beyond typing and paste-import (file drop, batch queue, bookmarklet, OCR, voice, URL/LLM/email), each mapped onto the Stage 22 import funnel with the general pattern named; file drop, the batch queue, and the dictation hint have shipped (Stage 22 v1.1–v1.2, PR #83), the rest remain research. |
