...
| [Testing pure functions with Vitest](./testing-pure-functions.md) | characterization testing · equivalence partitioning + boundary values · round-trip (inverse) testing | Stage 20 §3.1 sweep; `src/lib/scaleQuantity.test.js` | 2026-07-28 |
